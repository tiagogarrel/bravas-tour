...
function matchRoutesImpl$1(routes, locationArg, basename, allowPartial) {
	...
	for (let i = 0; matches == null && i < branches.length; ++i) matches = matchRouteBranch$1(branches[i], decoded, allowPartial);
	return matches;
}
...
function resolvePath(to, fromPathname) {
	...
	if (toPathname) if (isAbsoluteUrl$1(toPathname)) pathname = toPathname;
		...
		if (toPathname.includes("//")) {
			...
			toPathname = removeDoubleSlashes$1(toPathname);
...
var removeDoubleSlashes$1 = (path) => path.replace(/\/\/+/g, "/");
/**
* @private
*/
var joinPaths$1 = (paths) => removeDoubleSlashes$1(paths.join("/"));
/**
* @private
*/
...
function normalizeRedirectLocation$1(location, currentUrl, basename, historyInstance) {
	...
	if (ABSOLUTE_URL_REGEX$4.test(location)) {
		...
		if (url.origin === currentUrl.origin && isSameBasename) return removeDoubleSlashes$1(url.pathname) + url.search + url.hash;
	}
	try {
